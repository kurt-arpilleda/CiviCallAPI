...
$notifId = isset($_POST['notifId']) ? (int)$_POST['notifId'] : 0;

if ($authToken === '' || $notifId <= 0) {
    $response['success'] = false;
    $response['message'] = 'Auth token and notification ID are required.';
...
");
$updateStmt->bind_param("iii", $notifId, $userCampus, $currentUserId);
$updateStmt->execute();
